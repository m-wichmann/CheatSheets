...
\begin{multicols}{3}
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{cschapter}{Slicing / List / Tuple}
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{cschapter}{Codestyle (PEP8)}
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{cschapter}{String Methods}
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % TODO: Built-in Functions (abs, bin, filter, hash, hex, isinstance, len, oct, open, print, range, reversed, sorted, type)
    \begin{cschapter}{Built-in Functions}
        ...
        \csitem{\code{open(file,mode='r')}}{Returns opened file handler.}
